...
!(function (t, e) {
                ...
                (function (t, e, n) {
                    ...
                    xt(o, "confirm", n),
                        ...
                        (function (t, e, n, o) {
                            ...
                            o.denyButtonColor &&
                                ((e.style.backgroundColor = o.denyButtonColor), at(e, C["default-outline"]));
                            o.cancelButtonColor &&
        ...
        n &&
            (!(function (t, e) {
                "string" == typeof e
                    ...
                    : e || at([document.documentElement, document.body], C["no-backdrop"]);
            })(n, e.backdrop),
            (function (t, e) {
                if (!e) return;
                e in C
                    ? at(t, C[e])
                    : (B('The "position" parameter is not valid, defaulting to "center"'), at(t, C.center));
            })(n, e.position),
            (function (t, e) {
                if (!e) return;
    ...
    var Rt = function (t, e) {
        ...
        Kt = function (t, e) {
            ...
            (t.className = "".concat(C.popup, " ").concat(ht(t) ? n.popup : "")),
                e.toast
                    ? (at([document.documentElement, document.body], C["toast-shown"]), at(t, C.toast))
                    : at(t, C.modal),
                nt(t, e, "popup"),
        ...
        ke = function (t, e, n, o, i) {
            Pt &&
                ...
                e.addEventListener(Pt, function (t) {
                    t.target === e &&
                        (b.swalCloseEventFinishedCallback(), delete b.swalCloseEventFinishedCallback);
                }));
        },
        Ee = function (t, e) {
            setTimeout(function () {
    ...
    var Tn,
        ...
        Sn = Object.freeze({
            ...
            bindClickHandler: function () {
                (Pn[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "data-swal-template"] =
                    this),
        ...
        On = (function () {
            function t(e, n) {
                i(this, t), (this.callback = e), (this.remaining = n), (this.running = !1), this.start();
            }
            return (
                a(t, [
                    {
    ...
    var Zn = new WeakMap(),
        $n = (function () {
            function t() {
                if (
                    (i(this, t), g(this, Zn, { writable: !0, value: void 0 }), "undefined" != typeof window)
                ) {
                    Tn = this;
